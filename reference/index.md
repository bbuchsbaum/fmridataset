...
The canonical observation-by-feature container, its accessors, lazy
views, explanation, binding, and coercion.
...
- [`validate_frame_schema()`](https://bbuchsbaum.github.io/fmridataset/reference/frame-schema-validation.md)
  [`compare_frame_schema()`](https://bbuchsbaum.github.io/fmridataset/reference/frame-schema-validation.md)
  [`validate_against_schema()`](https://bbuchsbaum.github.io/fmridataset/reference/frame-schema-validation.md)
  [`frame_schema_digest()`](https://bbuchsbaum.github.io/fmridataset/reference/frame-schema-validation.md)
...
Axis frames, blocks, durable ID policy, typed metadata records, typed
tables, and the identity contract.
...
- [`axis_id_policy()`](https://bbuchsbaum.github.io/fmridataset/reference/id-policy.md)
  [`ids_are_durable()`](https://bbuchsbaum.github.io/fmridataset/reference/id-policy.md)
...
- [`unaligned_record()`](https://bbuchsbaum.github.io/fmridataset/reference/unaligned_record.md)
  : Construct a typed unaligned metadata record
- [`validate_unaligned_record()`](https://bbuchsbaum.github.io/fmridataset/reference/validate_unaligned_record.md)
...
- [`validate_auxiliary_table()`](https://bbuchsbaum.github.io/fmridataset/reference/auxiliary-table.md)
  [`table_data()`](https://bbuchsbaum.github.io/fmridataset/reference/auxiliary-table.md)
  [`table_key()`](https://bbuchsbaum.github.io/fmridataset/reference/auxiliary-table.md)
  [`table_role()`](https://bbuchsbaum.github.io/fmridataset/reference/auxiliary-table.md)
...
- [`canonicalization_contract()`](https://bbuchsbaum.github.io/fmridataset/reference/canonicalization_contract.md)
  : Identity and canonicalization contract
- [`canonical_bytes()`](https://bbuchsbaum.github.io/fmridataset/reference/canonical-encoding.md)
...
Volume, surface, parcel, basis, composite, and index spaces, their
generics, and spatial compatibility.
...
- [`n_features()`](https://bbuchsbaum.github.io/fmridataset/reference/feature-space.md)
  ...
  [`assert_same_space()`](https://bbuchsbaum.github.io/fmridataset/reference/feature-space.md)
...
The serializable ArraySource protocol, in-memory, NIfTI, sharded, and
Zarr sources, realization budgets, block planning, and spatial
execution.
...
Developer-only instruments for certifying zero-I/O, lifecycle, and
failure laws.
