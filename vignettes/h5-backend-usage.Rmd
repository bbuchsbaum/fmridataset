...
- **Level 3**: Frequent data access, active analysis phase
- **Level 6**: Balanced performance for standard workflows
- **Level 9**: Maximum compression for archival storage
...
1. Execute `validate_h5_dataset()` after file creation
2. Verify checksums after network transfers
3. Validate structure after storage migrations
4. Test partial data access before full analysis

## Chunk Size Optimization

**Access Pattern Configuration**:
- **Temporal analyses**: Configure larger time dimension chunks (e.g., 50-100 timepoints)
- **Spatial analyses**: Configure larger spatial chunks (e.g., 10000+ voxels)
- **Mixed access**: Use balanced chunks (e.g., 20 timepoints × 5000 voxels)
...
```{r h5-performance-troubleshooting, eval=FALSE}
