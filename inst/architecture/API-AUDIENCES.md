...
- FDS inspection and persistence.

There is no legacy migration surface. The pre-frame 0.x architecture was
removed rather than adapted; see `NEWS.md` for the boundary revision.
